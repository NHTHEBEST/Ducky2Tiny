...
echo =================================
link /libpath:.\ littleWire_util.obj unManaged_USB.obj micronucleus_lib.obj Managed_USB.obj  Flasher.netmodule /entry:Attiny.Flasher.Main /out:Flasher.exe /subsystem:console /ltcg /machine:X86 libusb.lib 
echo =================================
echo ===========TESTING===============
echo =================================
Flasher.exe
